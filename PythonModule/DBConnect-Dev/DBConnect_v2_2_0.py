...
class DBConnect:
    ...
    class FileReader:
        ...
        def read_file(self, parent_folder: str, file_name: str, file_sheetname: str = None):
            """
            Read a file and return its contents as a DataFrame.

            Args:
                parent_folder (str): Folder containing the file.
                file_name (str): File name.
                file_sheetname (str, optional): Sheet name for Excel files (required).

            Raises:
                ValueError: If unsupported file type or missing Excel sheet name.
            """
            ...
            match ext:
                ...
                case ".xlsx" | ".xlsm" | ".xls" | ".xlsb":
                    if not file_sheetname:
                        raise ValueError(f"Sheet name must be provided for Excel file: {file_name}")
